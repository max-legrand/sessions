...
[![Go Report Card](https://goreportcard.com/badge/github.com/max-legrand/sessions)](https://goreportcard.com/report/github.com/max-legrand/sessions)
[![GoDoc](https://godoc.org/github.com/max-legrand/sessions?status.svg)](https://godoc.org/github.com/max-legrand/sessions)
...
```bash
$ go get github.com/max-legrand/sessions
```

Import it in your code:

```go
import "github.com/max-legrand/sessions"
```
...
import (
	...
	"github.com/max-legrand/sessions/cookie"
...
import (
	"github.com/max-legrand/sessions"
	"github.com/max-legrand/sessions/redis"
	"github.com/gin-gonic/gin"
)
...
import (
	...
	"github.com/max-legrand/sessions"
	"github.com/max-legrand/sessions/memcached"
	"github.com/gin-gonic/gin"
)
...
import (
	"github.com/max-legrand/sessions"
	"github.com/max-legrand/sessions/mongo"
	"github.com/gin-gonic/gin"
...
import (
	"github.com/max-legrand/sessions"
	"github.com/max-legrand/sessions/memstore"
	"github.com/gin-gonic/gin"
)
